import { Directive, ElementRef, OnInit, Input, Renderer2, OnChanges, SimpleChanges } from '@angular/core';
    ...
    updateElement(): void {
        ...
        if (this.userRoles.indexOf(this.elementRole) === -1) {
            ...
            if (this.disableInputAttr) {
                this.renderer.setAttribute(this.element.nativeElement, 'disableInput', 'true');
